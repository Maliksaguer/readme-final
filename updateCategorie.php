...
if (isset($_GET['id'])) {
    $categorie = $categorieController->showCategorie($_GET['id']);
}
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 class="text-center mb-4 text-primary">Modifier une Catégorie</h3>
                  ...
                  <form method="POST" class="form-section">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nom_categorie" name="nom_categorie" value="<?= htmlspecialchars($categorie['nom_categorie']) ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="desc_categorie">Description</label>
                      <textarea class="form-control" id="desc_categorie" name="desc_categorie" rows="4" required><?= htmlspecialchars($categorie['desc_categorie']) ?></textarea>
                    </div>
